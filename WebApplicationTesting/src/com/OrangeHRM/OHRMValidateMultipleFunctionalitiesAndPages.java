...
public class OHRMValidateMultipleFunctionalitiesAndPages extends BaseTest {
	...
	Logger log = Logger.getLogger("OHRMValidateMultipleFunctionalitiesAndPages");
	...
	public void loginPageTest() throws IOException {
		...
		addEmployeeFile = new FileInputStream(
				"./src/com/OHRMAddEmployeeDataFiles/MultipleFunctionalityAndPagesTestSheet.xlsx");
		...
		for (int rowOfCellIndex = 0; rowOfCellIndex < 3; rowOfCellIndex++) {
			...
			String expected_LoginPanelHeadingText = row.getCell(rowOfCellIndex).getStringCellValue();
			...
			if (actual_LoginPanelHeadingText.equals(expected_LoginPanelHeadingText)) {
				...
				row.createCell(rowOfCellIndex)
						.setCellValue("The expected Login panel Heading Text does not match - FAIL");
			}
		}
	}
	...
	public void invalidLoginTest() throws IOException {
		...
		for (int rowOfCellIndex = 3; rowOfCellIndex < 8; rowOfCellIndex++) {
			...
			log.info("The user name is : " + invalidUser);

			String invalidPassword = "rag%$$kk";
			log.info("The password is : " + invalidPassword);
			...
			log.info("The expected error message is :- " + expectedErrorMessage);
			...
			log.info("The actual error message is :- " + actualErrorMessage);

			// System.out.println("The Login Page actual Error Message is:
			// "+actualErrorMessage);
			...
			if (actualErrorMessage.equals(expectedErrorMessage)) {
				// System.out.println("expected error message matches");
				log.info("expected error message matches -PASS");

				row.createCell(rowOfCellIndex).setCellValue("expected error message matches-PASS");
			}

			else {
				// System.out.println("expected error message doesn't match");
				log.info("expected error message doesn't match -FAIL");

				row.createCell(rowOfCellIndex).setCellValue("expected error message doesn't match-FAIL");
			}
		}
	}
	...
	public void validateHomePageTest() throws IOException {
		...
		for (int rowOfCellIndex = 8; rowOfCellIndex < 14; rowOfCellIndex++) {
			...
			log.info("The user name is : " + actual_UserName);

			String actual_Password = properties.getProperty("Password");
			log.info("The password is : " + actual_Password);
			...
			log.info("The expected home page welcome text is :- " + expectedHomePageWelcomeText);

			rowOfCellIndex++;

			// finding the save button element using link Text
			welcomeAdminElementProperty = By
			...
			log.info("The actual home page welcome text is :- " + actualHomePageWelcomeText);
			...
			if (actualHomePageWelcomeText.contains(expectedHomePageWelcomeText)) {
				...
				// "+actualHomePageWelcomeText);
				log.info("The expected welcome home page text exists " + actualHomePageWelcomeText);
				...
				// System.out.println("The expected welcome text doesn't exist
				// "+actualHomePageWelcomeText);
				log.info("The expected welcome text doesn't exist " + actualHomePageWelcomeText);
			...
			By addEmployeeElementproperty = By
					.linkText(properties.getProperty("loginWebPageAddEmployeeElementProperty"));
			...
			// identifying the add Employee Heading by xpath property -
			...
			if (actualAddEmployeePageText.contains(expectedAddEmployeePageText)) {
				...
				log.info("The expected add Employee Page Text exists");
				...
				log.info("The expected add Employee Page Text doesn't exist");
	...
	public void addEmloyeeTest() throws IOException {
		...
		for (int rowOfCellIndex = 14; rowOfCellIndex < 17; rowOfCellIndex++) {
			...
			log.info("The expected first name to be entered is :- " + sheetFirstName);
			...
			log.info("The expected middle name to be entered is :- " + sheetMiddleName);
			...
			log.info("The expected last name to be entered is :- " + sheetLastName);
			...
			log.info("The expected auto generated id is :- " + autoGeneratedId);
	...
	public void validatingPersonalDetailsPageTest() throws IOException {
		...
		for (int rowOfCellIndex = 17; rowOfCellIndex < 20; rowOfCellIndex++) {
			...
			// sending the first middle last name present in excel sheeet first middle last
			// name elements
			...
			// System.out.println("The expected Personal Details Page Text
			// "+expectedPersonalDeatilsPageText);
			log.info("The expected Personal Details Page Text :- " + expectedPersonalDeatilsPageText);

			rowOfCellIndex++;

			// identifying persoal details page text by xpath property
			// ///html/body/div[1]/div[3]/div/div[1]/h1
			// <h1>Personal Details</h1>

			By personalDetailsElementProperty = By
					.xpath(properties.getProperty("addEmployeePagePersonalDetailsHeading"));
			...
			log.info("The actual Personal Details Page Text :- " + actualPersonalDeatilsPageText);

			// System.out.println("The actual Personal Details Page Text is
			// "+actualPersonalDeatilsPageText);
			...
			if (actualPersonalDeatilsPageText.contains(expectedPersonalDeatilsPageText)) {
				// System.out.println("The expected personal details text exists
				// "+actualPersonalDeatilsPageText);
				log.info("The expected personal details text exists :-PASS");
				...
				log.info("The expected personal details text doesn't exist :-FAIL");
...
//getting the values stored in first,middle,last name text box elements 
			...
			By actualFirstNameElementProperty = By
					.id(properties.getProperty("loginWebPageFirstNameOutputElementProperty"));
			...
			if (sheetFirstName.equals(actualFirstName)) {
				...
				log.info("The expected first name matches -PASS");
				...
				log.info("The expected first name doesn't match -FAIL");
			...
			if (sheetMiddleName.equals(actualMiddleName)) {
				...
				// System.out.println("The expected middle name matches-PASS");
				log.info("The expected middle name matches -PASS");
				...
				// System.out.println("The expected middle name doesn't match -FAIL");
				log.info("The expected middle name doesn't match -FAIL");
			...
			By actualLastNameElementProperty = By
					.id(properties.getProperty("loginWebPageLastNameOutputElementProperty"));
			...
			if (sheetLastName.equals(actualLastName)) {
				...
				// System.out.println("The expected last name matches -PASS");
				log.info("The expected last name matches -PASS");
				...
				// System.out.println("The expected last name doesn't match -FAIL");
				log.info("The expected last name doesn't match -FAIL");
			...
			By actualEmployeIdElementProperty = By
					.id(properties.getProperty("loginWebPageActualEmployeeIdElementProperty"));
			...
			if (actualEmployeeId.equals(autoGeneratedId)) {
				...
				// System.out.println("The expected employee id matches -PASS");
				log.info("The expected employee id matches -PASS");
				...
				log.info("The expected employee id doesn't match");
			...
			By fullNameElementProperty = By.xpath(properties.getProperty("addEmployeePageActualFullNameHeading"));

			WebElement fullNameElement = driver.findElement(fullNameElementProperty);

			String fullName = fullNameElement.getText();
			log.info("The Full name of the employee is :- " + fullName);

			row.createCell(rowOfCellIndex).setCellValue(fullName);

			rowOfCellIndex++;

			if (fullName.contains(actualFirstName) || fullName.contains(actualMiddleName)
					|| fullName.contains(actualLastName)) {

				// System.out.println("The expected name exists -PASS");
				log.info("The expected name exists -PASS");
				...
				// System.out.println("The expected name doesn't exist -FAIL");
				log.info("The expected name doesn't exist -FAIL");
		...
		outputFile = new FileOutputStream(
				"./src/com/OHRMAddEmployeeDataResultFiles/MultipleFunctionalitesAndPagesTestSheetResult.xlsx");
